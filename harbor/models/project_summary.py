...
class ProjectSummary(object):
    ...
    def __init__(self, repo_count=None, chart_count=None, project_admin_count=None, maintainer_count=None, developer_count=None, guest_count=None, limited_guest_count=None, quota=None, registry=None):  # noqa: E501
