...
class Instance(object):
    ...
    def __init__(self, id=None, name=None, description=None, vendor=None, endpoint=None, auth_mode=None, auth_info=None, status=None, enabled=None, default=None, insecure=None, setup_timestamp=None):  # noqa: E501
