...
class Metrics(object):
    ...
    def __init__(self, task_count=None, success_task_count=None, error_task_count=None, pending_task_count=None, running_task_count=None, scheduled_task_count=None, stopped_task_count=None):  # noqa: E501
