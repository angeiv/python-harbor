...
class NativeReportSummary(object):
    ...
    def __init__(self, report_id=None, scan_status=None, severity=None, duration=None, summary=None, start_time=None, end_time=None, complete_percent=None, scanner=None):  # noqa: E501
