...
class GeneralInfo(object):
    ...
    def __init__(self, with_notary=None, with_chartmuseum=None, registry_url=None, external_url=None, auth_mode=None, project_creation_restriction=None, self_registration=None, has_ca_root=None, harbor_version=None, registry_storage_provider_name=None, read_only=None, notification_enable=None, authproxy_settings=None):  # noqa: E501
