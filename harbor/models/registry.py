...
class Registry(object):
    ...
    def __init__(self, id=None, url=None, name=None, credential=None, type=None, insecure=None, description=None, status=None, creation_time=None, update_time=None):  # noqa: E501
