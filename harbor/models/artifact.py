...
class Artifact(object):
    ...
    def __init__(self, id=None, type=None, media_type=None, manifest_media_type=None, project_id=None, repository_id=None, digest=None, size=None, push_time=None, pull_time=None, extra_attrs=None, annotations=None, references=None, tags=None, addition_links=None, labels=None, scan_overview=None):  # noqa: E501
