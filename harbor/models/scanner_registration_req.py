...
class ScannerRegistrationReq(object):
    ...
    def __init__(self, name=None, description=None, url=None, auth='', access_credential=None, skip_cert_verify=False, use_internal_addr=False, disabled=False):  # noqa: E501
