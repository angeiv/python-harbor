...
class ScannerRegistration(object):
    ...
    def __init__(self, uuid=None, name=None, description=None, url=None, disabled=False, is_default=False, health='', auth='', access_credential=None, skip_cert_verify=False, use_internal_addr=False, adapter=None, vendor=None, version=None):  # noqa: E501
