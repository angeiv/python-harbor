...
class Execution(object):
    ...
    def __init__(self, id=None, vendor_type=None, vendor_id=None, status=None, status_message=None, metrics=None, trigger=None, extra_attrs=None, start_time=None, end_time=None):  # noqa: E501
