...
class ReplicationExecution(object):
    ...
    def __init__(self, id=None, policy_id=None, status=None, trigger=None, start_time=None, end_time=None, status_text=None, total=None, failed=None, succeed=None, in_progress=None, stopped=None):  # noqa: E501
