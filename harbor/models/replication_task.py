...
class ReplicationTask(object):
    ...
    def __init__(self, id=None, execution_id=None, status=None, job_id=None, operation=None, resource_type=None, src_resource=None, dst_resource=None, start_time=None, end_time=None):  # noqa: E501
