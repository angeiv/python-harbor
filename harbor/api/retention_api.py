...
class RetentionApi(object):
    ...
    def create_retention(self, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_retention(body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.create_retention_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_retention_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_retention_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create Retention Policy  # noqa: E501

        Create Retention Policy, you can reference metadatas API for the policy model. You can check project metadatas to find whether a retention policy is already binded. This method should only be called when no retention policy binded to project yet.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_retention_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_retention`")  # noqa: E501
    ...
    def list_retention_tasks_with_http_info(self, id, eid, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'eid', 'page', 'page_size']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def operate_retention_execution(self, body, id, eid, **kwargs):  # noqa: E501
        """Stop a Retention execution  # noqa: E501

        Stop a Retention execution, only support \"stop\" action now.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.operate_retention_execution(body, id, eid, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.operate_retention_execution_with_http_info(body, id, eid, **kwargs)  # noqa: E501
        else:
            (data) = self.operate_retention_execution_with_http_info(body, id, eid, **kwargs)  # noqa: E501
            return data

    def operate_retention_execution_with_http_info(self, body, id, eid, **kwargs):  # noqa: E501
        """Stop a Retention execution  # noqa: E501

        Stop a Retention execution, only support \"stop\" action now.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.operate_retention_execution_with_http_info(body, id, eid, async_req=True)
        >>> result = thread.get()
    ...
    def trigger_retention_execution(self, body, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.trigger_retention_execution(body, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.trigger_retention_execution_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.trigger_retention_execution_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def trigger_retention_execution_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Trigger a Retention Execution  # noqa: E501

        Trigger a Retention Execution, if dry_run is True, nothing would be deleted actually.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.trigger_retention_execution_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
    ...
    def update_retention(self, body, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_retention(body, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_retention_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_retention_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_retention_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Update Retention Policy  # noqa: E501

        Update Retention Policy, you can reference metadatas API for the policy model. You can check project metadatas to find whether a retention policy is already binded. This method should only be called when retention policy has already binded to project.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_retention_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_retention`")  # noqa: E501
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
