...
class ScanAllApi(object):
    ...
    def create_scan_all_schedule(self, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_scan_all_schedule(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Schedule body: Create a schedule or a manual trigger for the scan all job. (required)
        :return: None
        ...
        if kwargs.get('async_req'):
            return self.create_scan_all_schedule_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.create_scan_all_schedule_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def create_scan_all_schedule_with_http_info(self, body, **kwargs):  # noqa: E501
        """Create a schedule or a manual trigger for the scan all job.  # noqa: E501

        This endpoint is for creating a schedule or a manual trigger for the scan all job, which scans all of images in Harbor.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_scan_all_schedule_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `create_scan_all_schedule`")  # noqa: E501
    ...
    def update_scan_all_schedule(self, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_scan_all_schedule(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Schedule body: Updates the schedule of scan all job, which scans all of images in Harbor. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_scan_all_schedule_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.update_scan_all_schedule_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def update_scan_all_schedule_with_http_info(self, body, **kwargs):  # noqa: E501
        """Update scan all's schedule.  # noqa: E501

        This endpoint is for updating the schedule of scan all job, which scans all of images in Harbor.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_scan_all_schedule_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_scan_all_schedule`")  # noqa: E501
