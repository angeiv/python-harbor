...
class ProjectApi(object):
    ...
    def create_project_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        all_params = ['body', 'x_request_id', 'x_resource_name_in_location']  # noqa: E501
    ...
    def list_projects_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['x_request_id', 'page', 'page_size', 'name', 'public', 'owner', 'with_detail']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_project(self, body, project_name_or_id, **kwargs):  # noqa: E501
        """Update properties for a selected project.  # noqa: E501

        This endpoint is aimed to update the properties of a project.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_project(body, project_name_or_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_project_with_http_info(body, project_name_or_id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_project_with_http_info(body, project_name_or_id, **kwargs)  # noqa: E501
            return data

    def update_project_with_http_info(self, body, project_name_or_id, **kwargs):  # noqa: E501
        """Update properties for a selected project.  # noqa: E501

        This endpoint is aimed to update the properties of a project.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_project_with_http_info(body, project_name_or_id, async_req=True)
        >>> result = thread.get()
