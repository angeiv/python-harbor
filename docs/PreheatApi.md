...
# **list_instances**
> list[Instance] list_instances(x_request_id=x_request_id, page=page, page_size=page_size, q=q)
...
# **manual_preheat**
> manual_preheat(body, project_name, preheat_policy_name, x_request_id=x_request_id)
...
try:
    # Manual preheat
    api_instance.manual_preheat(body, project_name, preheat_policy_name, x_request_id=x_request_id)
except ApiException as e:
