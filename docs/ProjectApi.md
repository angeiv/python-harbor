...
# **create_project**
> create_project(body, x_request_id=x_request_id, x_resource_name_in_location=x_resource_name_in_location)
...
try:
    # Create a new project.
    api_instance.create_project(body, x_request_id=x_request_id, x_resource_name_in_location=x_resource_name_in_location)
...
# **update_project**
> update_project(body, project_name_or_id, x_request_id=x_request_id, x_is_resource_name=x_is_resource_name)
...
try:
    # Update properties for a selected project.
    api_instance.update_project(body, project_name_or_id, x_request_id=x_request_id, x_is_resource_name=x_is_resource_name)
except ApiException as e:
